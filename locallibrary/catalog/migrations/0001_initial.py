# Generated by Django 3.1.7 on 2022-03-08 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summery', models.TextField(help_text='write a brief summary of the book', max_length=2000)),
                ('ISBN', models.CharField(help_text='ISBN is maximum length of 13', max_length=13, unique=True, verbose_name='ISBN')),
        ...
        migrations.AddField(
            model_name='book',
            name='gener',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='catalog.Gener'),
        ),
    ]
